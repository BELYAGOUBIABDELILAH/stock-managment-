...
function addRow(r,l,p,q){
  ...
  if(!exist){
    ...
    '<td> <div style="font-size: 0.9rem;">'+p+' DA</div>  <input type="hidden" name="cart['+i+'][1]" id="prix" value="'+p+'" min="1" class="form-control prix" style="font-size: 0.9rem;">  </td> '+
    ...
    '<td> <div id="total'+i+'" style="font-size: 0.9rem;">'+p+' DA</div> </td>'+
...
function total(id,prix){
  var qnt,iprix;
    ...
    iprix = parseInt(prix);
    document.getElementById("total"+id).innerHTML=String(iprix*qnt)+" DA";
  } 

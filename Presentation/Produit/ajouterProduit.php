                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="first-name-vertical" class="form-control"
                                                        name="reference" placeholder="Reference" required autofocus>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" id="contact-info-vertical" class="form-control"
                                                        name="prix" placeholder="Prix unitaire" required >
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" id="email-id-vertical" class="form-control"
                                                        name="quantite" placeholder="Quantite en stock" required >
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" id="email-id-vertical" class="form-control"
                                                        name="achat" placeholder="Prix d'achat" required >
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">

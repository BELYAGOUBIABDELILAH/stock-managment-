        ...
        <div class="sidebar-wrapper active" style="left:0;">
            <div class="sidebar-header position-relative">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="logo">
                        <a href="../dashboard.php"><img src="../assets/images/logo/kisspng-web-development-e-commerce-logo-electronic-busines-ecommerce-5ad142afc13966.5141508215236635357915.png" alt="Logo"
                    ...
                    <div class="card-body py-4 px-4">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-1 name">
                                ...
                                <h6 class="text-muted mb-0">Mini-Projet</h6>
                            </div>
                            ...
                            <div class="card-body px-4 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        ...
                                        <h6 class="font-extrabold mb-0">
                                            <?php require "../Metier/produit.php";
                                            echo Produit::total();?>
                                        </h6>
                                    </div>
                                </div>
                            ...
                            <div class="card-body px-4 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        ...
                                        <h6 class="font-extrabold mb-0"><?=DAO::Income()?> DA</h6>
                                        </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="card">
                            ...
                            <div class="card-body" height="2rem" width="4rem">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4>Produits Plus Disponibles</h4>
                            </div>
                            <div class="card-content pb-4">
                                <?php
                                include_once "C:xampp\htdocs\Mini\DAO\DAO.php";
                                include_once "C:xampp\htdocs\Mini\Metier\produit.php";

                                // Afficher les 3 produits en tendance
                                Produit::afficherTopProduits(3);
                                ?>
                            </div>
                        </div>
                    </div>

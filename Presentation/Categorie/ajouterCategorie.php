                ...
                <div class="card">
                    ...
                    <div class="card">
                        ...
                        if (isset($_SESSION['erreur'])) {
                            echo '<div class="alert alert-light-danger color-danger">
                                  <i class="bi bi-x-circle"></i> '. $_SESSION['erreur'] . '
                                  </div>';
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="password-vertical" class="form-control"
                                                        name="idCategorie" placeholder="Id Categorie" required autofocus>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="first-name-vertical" class="form-control"
                                                        name="nomCategorie" placeholder="Nom Categorie" required >
                                                </div>
                                            </div>

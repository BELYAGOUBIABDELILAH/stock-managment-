                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="modal fade bd-example-modal-md"
                                                        id="update<?=$t->get("i")?>" tabindex="0" role="dialog"
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered modal-md">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <form class="form form-vertical form-group"
                                                                        method="post" action="modifierFournisseur.php">
                                                                        <div class="form-body">
                                                                            <div class="row">
                                                                                <div class="col-12">
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-secondary"
                                                                        data-bs-dismiss="modal">Close</button>
                                                                    <a
                                                                        href='supprimerFournisseur.php?id=<?=$t->get("i")?>'>
                                                                        <button type="button"

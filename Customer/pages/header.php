        ...
        <div id="main" class="layout-horizontal">
            <header class="mb-5">
                ...
                <nav class="main-navbar d-flex justify-content-between align-items-center">
                    <div class="logo">
                        <a href="index.html"><img src="../assets/images/logo/kisspng-web-development-e-commerce-logo-electronic-busines-ecommerce-5ad142afc13966.5141508215236635357915.png" height="30px" alt="Logo"></a>
                    </div>
                    <div class="">
                        <ul>
                            ...
                            <li class="menu-item active has-sub">
                                ...
                                <div
                                    ...
                                    <div class="submenu-group-wrapper">
                                        ...
                                        <ul class="submenu-group">
                                        <?php
                                        require_once("C:xampp\htdocs\Mini\DAO\DAO.php");
                                        require_once("C:xampp\Mini\Metier\categorie.php");
